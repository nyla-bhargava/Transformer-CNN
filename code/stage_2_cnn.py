...
Original file is located at
    https://colab.research.google.com/drive/1rjBgIZJ-eXDdQ6FRKn77IaJ-QusXygMh
"""

!pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu121
!pip install transformers==4.45.2 pandas scikit-learn einops
...
models = ["Stage-2 only", "Stage-1 + Stage-2"]
auc_scores = [0.7081, 0.6469]
aupr_scores = [0.2789, 0.2553]

plt.figure()
plt.bar(models, auc_scores)
plt.ylabel("ROC-AUC")
plt.title("TrueOT ROC-AUC Comparison")
plt.tight_layout()
plt.show()